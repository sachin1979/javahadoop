...
public LongWritable getCurrentKey() throws IOException,
	...
	LOG.info("Inside getCurrentKey() method: " + key.toString());
	return key;
}
...
public Text getCurrentValue() throws IOException, InterruptedException {
	...
	LOG.info("Inside getCurrentValue() method: " + name);
	
	if (name != null && (name.toUpperCase().contains("NADAL") || name.toUpperCase().contains("FEDERER"))) {
		LOG.info("Inside getCurrentValue() method returning sachin: " + name);
		return new Text(value.toString() + " sachin ");
	}
	else {
		LOG.info("Inside getCurrentValue() method returning original: " + name);
		return value;
	}
}
